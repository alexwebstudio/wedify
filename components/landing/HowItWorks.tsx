...
const STEPS = [
  {
    ...
    text: 'Шесть готовых направлений — от камерного торжества до вечернего приёма. Оформление можно поменять в любой момент, поэтому выбор ни к чему не обязывает.',
  },
  {
    n: '02',
  ...
  },
  {
    ...
    text: 'Сайт публикуется по вашему адресу и открывается с любого телефона. Ответы на приглашение приходят вам, а правки после публикации подхватываются сами.',
  },
]

export function HowItWorks({ startHref }: { startHref: string }) {
  return (
    <section className="mrn-section mrn-tone-milk">
